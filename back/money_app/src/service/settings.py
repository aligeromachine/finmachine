...
LOGGING_RAW, ENV_APP_RAW, JWT_SECRET_KEY_RAW, JWT_ALGORITHM_RAW, JWT_ACCESS_LIFE_RAW, 
JWT_REFRESH_LIFE_RAW, CORS_ALLOW_METHODS_RAW, CORS_ALLOW_HEADERS_RAW, CORS_ALLOW_CREDENTIALS_RAW)
...
JWT_SECRET_KEY, JWT_ALGORITHM  = JWT_SECRET_KEY_RAW, JWT_ALGORITHM_RAW
JWT_ACCESS_TOKEN_LIFETIME, JWT_REFRESH_TOKEN_LIFETIME = JWT_ACCESS_LIFE_RAW, JWT_REFRESH_LIFE_RAW
